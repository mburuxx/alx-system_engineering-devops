# Networking basics
Projects done during **Full Stack Software Engineering studies** at **ALX Africa**.
It aims to teach about what is an OSI model, LAN, WAN, IP address, localhost, subnet and TCP/UDP.
