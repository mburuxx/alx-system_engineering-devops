# Web server
Project done during **Full Stack Software Engineering studies** at **ALX Africa**. It aims to teach about the roles of web servers and their processes (parent and child), and DNS roles.
